...
(function() {
    var provider = app.data.testDb = new Everlive({
            offlineStorage: true,
            apiKey: 'Ve0vxcx2odrKrpds',
    ...
    document.addEventListener('online', function() {
        app.data.testDb.offline(false);
        app.data.testDb.sync();
    });

    document.addEventListener('offline', function() {
        app.data.testDb.offline(true);
    });

}());

// START_CUSTOM_CODE_testDb
// END_CUSTOM_CODE_testDb